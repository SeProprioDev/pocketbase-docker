...
`helm upgrade pocketbase oci://rg.fr-par.scw.cloud/sepropriodev/pocketbase-helm --version 0.7.0 --install`
...
### From 0.6.X (pocketbase v0.8.X) to 0.7.x (pocketbase v0.9.X)
